...
namespace modernRX {
	...
	private:
		...
		[[nodiscard]] const DecodeBuffer& selectDecodeBuffer(const SuperscalarInstructionType instr, const uint32_t decode_cycle, const uint32_t mul_count);
		...
		[[nodiscard]] SuperscalarInstructionType selectInstructionTypeForDecodeBuffer(const DecodeBuffer& decode_buffer, const uint32_t buffer_index);
		...
		[[nodiscard]] SuperscalarInstruction initializeInstruction(const SuperscalarInstructionType type);
