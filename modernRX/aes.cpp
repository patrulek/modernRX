...
namespace modernRX::aes {
    namespace {
        constexpr uint32_t alignas(16) LUT_Enc0[256] = {
        ...
        constexpr uint32_t alignas(16) LUT_Enc1[256] = {
        ...
        constexpr uint32_t alignas(16)  LUT_Enc2[256] = {
        ...
        constexpr uint32_t alignas(16)  LUT_Enc3[256] = {
        ...
        constexpr uint32_t alignas(16)  LUT_Dec0[256] = {
        ...
        constexpr uint32_t alignas(16)  LUT_Dec1[256] = {
        ...
        constexpr uint32_t alignas(16)  LUT_Dec2[256] = {
        ...
        constexpr uint32_t alignas(16)  LUT_Dec3[256] = {
    ...
    void encode(std::span<uint32_t, 4> state, const_span<uint32_t, 4> key) noexcept {
        ...
        const auto s3{ state[0] };

        const_array<uint32_t, 4> tmp_state{
            LUT_Enc0[byte<0>(s0)] ^ LUT_Enc1[byte<1>(s3)] ^ LUT_Enc2[byte<2>(s2)] ^ LUT_Enc3[byte<3>(s1)],
            LUT_Enc0[byte<0>(s1)] ^ LUT_Enc1[byte<1>(s0)] ^ LUT_Enc2[byte<2>(s3)] ^ LUT_Enc3[byte<3>(s2)],
            LUT_Enc0[byte<0>(s2)] ^ LUT_Enc1[byte<1>(s1)] ^ LUT_Enc2[byte<2>(s0)] ^ LUT_Enc3[byte<3>(s3)],
            LUT_Enc0[byte<0>(s3)] ^ LUT_Enc1[byte<1>(s2)] ^ LUT_Enc2[byte<2>(s1)] ^ LUT_Enc3[byte<3>(s0)],
        };

        state[3] = tmp_state[0] ^ key[3];
        state[2] = tmp_state[1] ^ key[2];
        state[1] = tmp_state[2] ^ key[1];
    ...
    void decode(std::span<uint32_t, 4> state, const_span<uint32_t, 4> key) noexcept {
        ...
        const_array<uint32_t, 4> tmp_state{
            LUT_Dec0[byte<0>(s0)] ^ LUT_Dec1[byte<1>(s1)] ^ LUT_Dec2[byte<2>(s2)] ^ LUT_Dec3[byte<3>(s3)],
            LUT_Dec0[byte<0>(s1)] ^ LUT_Dec1[byte<1>(s2)] ^ LUT_Dec2[byte<2>(s3)] ^ LUT_Dec3[byte<3>(s0)],
            LUT_Dec0[byte<0>(s2)] ^ LUT_Dec1[byte<1>(s3)] ^ LUT_Dec2[byte<2>(s0)] ^ LUT_Dec3[byte<3>(s1)],
            LUT_Dec0[byte<0>(s3)] ^ LUT_Dec1[byte<1>(s0)] ^ LUT_Dec2[byte<2>(s1)] ^ LUT_Dec3[byte<3>(s2)],
        };
