...
namespace modernRX {
    ...
    struct alignas(32) BytecodeCompiler {
        ...
        void iaddrs_cmpl(const RxInstruction& instr, const uint32_t idx);
        void iaddm_cmpl(const RxInstruction& instr, const uint32_t idx);
        void isubr_cmpl(const RxInstruction& instr, const uint32_t idx);
        void isubm_cmpl(const RxInstruction& instr, const uint32_t idx);
        void imulr_cmpl(const RxInstruction& instr, const uint32_t idx);
        void imulm_cmpl(const RxInstruction& instr, const uint32_t idx);
        void imulhr_cmpl(const RxInstruction& instr, const uint32_t idx);
        void imulhm_cmpl(const RxInstruction& instr, const uint32_t idx);
        void ismulhr_cmpl(const RxInstruction& instr, const uint32_t idx);
        void ismulhm_cmpl(const RxInstruction& instr, const uint32_t idx);
        void inegr_cmpl(const RxInstruction& instr, const uint32_t idx);
        void ixorr_cmpl(const RxInstruction& instr, const uint32_t idx);
        void ixorm_cmpl(const RxInstruction& instr, const uint32_t idx);
        void irorr_cmpl(const RxInstruction& instr, const uint32_t idx);
        void irolr_cmpl(const RxInstruction& instr, const uint32_t idx);
        void imulrcp_cmpl(const RxInstruction& instr, const uint32_t idx);
        void iswapr_cmpl(const RxInstruction& instr, const uint32_t idx);
        void cbranch_cmpl(const RxInstruction& instr, const uint32_t idx);
        void fswapr_cmpl(const RxInstruction& instr, const uint32_t idx);
        void faddr_cmpl(const RxInstruction& instr, const uint32_t idx);
        void faddm_cmpl(const RxInstruction& instr, const uint32_t idx);
        void fsubr_cmpl(const RxInstruction& instr, const uint32_t idx);
        void fsubm_cmpl(const RxInstruction& instr, const uint32_t idx);
        void fscalr_cmpl(const RxInstruction& instr, const uint32_t idx);
        void fmulr_cmpl(const RxInstruction& instr, const uint32_t idx);
        void fdivm_cmpl(const RxInstruction& instr, const uint32_t idx);
        void fsqrtr_cmpl(const RxInstruction& instr, const uint32_t idx);
        void cfround_cmpl(const RxInstruction& instr, const uint32_t idx);
        void istore_cmpl(const RxInstruction& instr, const uint32_t idx);
    };
