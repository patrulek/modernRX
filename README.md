...
[ 2] Argon2d::fillMemory                      ... Passed (0.561s)
...
[ 9] Dataset::generate                        ... Passed (2.228s)
[10] Hasher::run                              ... Passed (2.300s)
```
...
* **v0.3.7 - 08.10.2023:** dataset generation optimization (std::vector replacement, blake2b/argon2d optimizations)
* ...
...
-------------------------------------------------------------------------------
C++ Header                      30            424            502           2356
C++                             15            501            322           2318
Markdown                         2            100              0            283
-------------------------------------------------------------------------------
TOTAL                           47           1025            824           4957
-------------------------------------------------------------------------------
```
