...
[ 2] Argon2d::fillMemory                      ... Passed (0.566s)
...
[ 9] Dataset::generate                        ... Passed (2.045s)
[10] Hasher::run                              ... Passed (2.131s)
```
...
* **v0.3.8 - 08.10.2023:** dataset generation optimization (JIT-compile all superscalar programs as a batch)
* ...
...
-------------------------------------------------------------------------------
C++ Header                      30            447            505           2524
C++                             15            496            330           2335
Markdown                         2            103              0            292
-------------------------------------------------------------------------------
TOTAL                           47           1046            835           5151
-------------------------------------------------------------------------------
```
